...
class QuestionListView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        if tag: 
            ...
            questions = Question.objects.filter(tags=_tag)
        else:
...
class CommentDetailView(CreateView):
    ...
    template_name = 'forumbase/question-detail.html'
    
    def form_valid(self, form):
        form.instance.question_id = self.kwargs['pk']
        return super().form_valid(form)
    success_url = reverse_lazy('forumbase:question-detail')

class AddCommentView(CreateView):
    model = Comment
    form_class = CommentForm
    
    template_name = 'forumbase/question-answer.html'
